...
public class main {
    ...
    public static void cargarDatos() throws IOException, ClassNotFoundException {
        ...
        try {
            ...
            ArrayList<Object> datos = (ArrayList<Object>) objetoEntrada.readObject();
            portaviones = (ArrayList<avion>) datos.get(0);
            tripulan = (ArrayList<tripulante>) datos.get(1);
            System.out.println("Se han leído los datos de los aviones y tripulantes");
        } catch (FileNotFoundException e) {
            System.out.println("Archivo no encontrado. Se creará al terminar la ejecución de este programa.");
        } finally {
    ...
    public static void añadirTripulante(Scanner teclado) {
        ...
        try{
        t = new tripulante(nombreTripulante, dniTripulante);
